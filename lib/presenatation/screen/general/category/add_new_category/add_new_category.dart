...
class AddCategory extends StatefulWidget {
  ...
  @override
  State<AddCategory> createState() => _AddTagState();
}

class _AddTagState extends State<AddCategory> {
            ...
            children: [
              ...
              BlocBuilder<CategoryCubit, CategoryState>(
                builder: (context, state) {
                  ...
                  print(state);
                  if (state is AddingNewCategoryState) {
                    isLoading = true;
                  }
                  ...
                  return PrimaryButton(
                    ...
                    onPressed: () async {
                      ...
                      context
                          .read<CategoryCubit>()
                          .addingNewCategory(title, slug, context);
                    },
                    isLoading: isLoading,
                  );
                },
