...
class UpdateCategory extends StatefulWidget {
  ...
  const UpdateCategory({super.key, required this.id, required this.title});

  @override
  State<UpdateCategory> createState() => _UpdateTagState();
}

class _UpdateTagState extends State<UpdateCategory> {
            ...
            children: [
              ...
              PrimaryButton(
                ...
                onPressed: () async {
                  ...
                  context
                      .read<CategoryCubit>()
                      .updateCategory(widget.id, title, slug);
